...
async function setup() {
  ...
  try {
    ...
    const personalityChoice = await question(
      'Choose personality (1-6, default: 1): '
    );
    const personalities = [
      'custom',
      'friendly',
    ...
    console.log('\n📏 Response Length');
    const maxLength = await question(
      'Max response length in characters (default: 100): '
    );
    ...
    const logChoice = await question(
      'Choose logging level (1-4, default: 3): '
    );
